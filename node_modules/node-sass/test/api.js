...
describe('api', function() {
  ...
  describe('.render(functions)', function() {
    ...
    it('should properly convert boolean when calling custom functions', function(done) {
      sass.render({
        data: 'div { color: if(foo(true, false), #fff, #1a1);' +
          '\n  background-color: if(foo(true, true), #fff, #1a1); }',
        functions: {
    ...
    it('should let custom functions call setter methods on wrapped sass values (boolean)', function(done) {
      sass.render({
        data: 'div { color: if(foo(false), #fff, #1a1); background-color: if(foo(true), #fff, #1a1); }',
        functions: {
          'foo($a)': function(a) {
    ...
    it('should properly convert maps when calling custom functions', function(done) {
      sass.render({
        data: '$test-map: foo((abc: 123, #def: true)); div { color: if(map-has-key($test-map, hello), #fff, #1a1); }' +
    ...
    it('should properly convert null when calling custom functions', function(done) {
      sass.render({
        data: 'div { color: if(foo("bar"), #fff, #1a1); } ' +
          'span { color: if(foo(null), #fff, #1a1); }' +
          'table { color: if(bar() == null, #fff, #1a1); }',
        functions: {
          'foo($a)': function(a) {
